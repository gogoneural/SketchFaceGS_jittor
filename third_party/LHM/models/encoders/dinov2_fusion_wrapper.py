...
class DPTHead(nn.Module):
    ...
    def execute(self, out_features, patch_h, patch_w):
        ...
        fusion_feats = jt.concat(out, dim=1)
...
class Dinov2FusionWrapper(nn.Module):
    ...
    def _preprocess_image(self, image, resolution: int = 1024):
        ...
        image = nn.pad(image, pad_size, value=1)

        # Replace kornia.geometry.resize with jittor interpolate
    ...
    def execute(self, image, mod=None):
        # image: [N, C, H, W]
        # mod: [N, D] or None
