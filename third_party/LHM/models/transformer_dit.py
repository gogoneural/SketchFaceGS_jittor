...
class SD3JointTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.attn.set_use_memory_efficient_attention_xformers(use_memory_efficient_attention_xformers=True)
        # SD-3.5
    ...
    def forward(
        ...
        attn_output, context_attn_output = self.attn(
            hidden_states=norm_hidden_states,
            encoder_hidden_states=norm_encoder_hidden_states,
            # image_rotary_emb = self.image_rotary_emb#.to(hidden_states)
        ...
        if self.use_dual_attention:
            attn_output2 = self.attn2(hidden_states=norm_hidden_states, image_rotary_emb = self.image_rotary_emb.to(hidden_states))
