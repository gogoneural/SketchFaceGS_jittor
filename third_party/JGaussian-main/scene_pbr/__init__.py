...
from scene_pbr.dataset_readers import sceneLoadTypeCallbacks
# from scene.gaussian_model import GaussianModel
from scene_pbr.gaussian_pbr_model import GaussianModel
from arguments import ModelParams
from utils.camera_utils import cameraList_from_2dgscamInfos, camera_to_JSON
from utils.system_utils import mkdir_p
from ops.NVDIFFREC import save_env_map, load_env
# import torch
import jittor as jt
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        for resolution_scale in resolution_scales:
            ...
            self.train_cameras[resolution_scale], _, _ = cameraList_from_2dgscamInfos(scene_info.train_cameras, resolution_scale, args)
            print("Loading Test Cameras")
            self.test_cameras[resolution_scale], _, _ = cameraList_from_2dgscamInfos(scene_info.test_cameras, resolution_scale, args)
