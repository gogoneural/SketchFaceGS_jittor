...
from gaussian_renderer_mip import render
import sys
from scene import SceneMip, GaussianModelMip
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    gaussians = GaussianModelMip(dataset.sh_degree)
    scene = SceneMip(dataset, gaussians)
...
def training_report(tb_writer, iteration, Ll1, loss, l1_loss, testing_iterations, scene : SceneMip, renderFunc, renderArgs):
    if tb_writer:
