...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        # self.envmap_path = ""
        self.segment_method = 'ours'
        self.random_initial = False
        self.brdf_dim = 0
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.proj_step = 0
        self.repel_step = 0
        self.smooth_step = 15000
        self.remove_threshold = 1000
        self.prune_nonvisible_until_iter = 30000
        self.weight_th = 0.5
        self.except_th = 0.002
...
class StyleOptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.img_tv_weight = 5
        self.lambda_mrloss = 6.0
        self.densification_interval = 100
        self.opacity_reset_interval = 300
        self.densify_from_iter = 500
        self.densify_until_iter = 15_000
        # self.densify_from_iter = 30_300
        # self.densify_until_iter = 30_601
...
def get_combined_args(parser : ArgumentParser):
    ...
    try:
        ...
        with open(cfgfilepath) as cfg_file:
            ...
            if 'delta_normal_lr' in cfgfile_string:
                cfgfile_string = cfgfile_string.split('(delta_normal_lr')[0][:-9]
    except TypeError:
