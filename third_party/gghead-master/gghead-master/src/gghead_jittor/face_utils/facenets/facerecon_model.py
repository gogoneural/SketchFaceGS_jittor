...
from recon_utils import util 
from recon_utils.nvdiffrast import MeshRenderer
from recon_utils.preprocess import estimate_norm_torch
...
class FaceReconModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--bfm_model', type=str, default='BFM_model_front_seg.mat', help='bfm model')
