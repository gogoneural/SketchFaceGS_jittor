...
from gghead_jittor.face_utils.arcface_torch.backbones import get_model
...
def resize_n(image, dsize=112):
    # image: (b, c, h, w)
    # M   :  (b, 2, 3)
    return nn.functional.interpolate(image, size=(dsize, dsize), mode='bicubic')
