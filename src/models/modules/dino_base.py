...
from facebookresearch_dinov2_main.dinov2.hub.backbones import dinov2_vitb14
class DINOBase(nn.Module):
    def __init__(self, output_dim=128, only_global=False):
        super().__init__()
        self.only_global = only_global
        torch.hub.set_dir('./hub/')
        self.dino_model = dinov2_vitb14()
        checkpoint = torch.load('./dinov2_vitb14.pth')
        self.dino_model.load_state_dict(checkpoint)
