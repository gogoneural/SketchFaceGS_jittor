...
from gghead.models.stylegan2 import GGHSynthesisNetwork
...
class GFPGANv1(nn.Module):
    ...
    def __init__(
        ...
        self.conv_body_first = ConvLayer(input_dim, channels[f'{first_out_size}'], 1, bias=True, activate=True)
        ...
        # self.stylegan_decoder = GGHSynthesisNetwork(
        #     out_size=out_size,
        #     num_style_feat=num_style_feat,
        #     num_mlp=num_mlp,
        #     channel_multiplier=channel_multiplier,
