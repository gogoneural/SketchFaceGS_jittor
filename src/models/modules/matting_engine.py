...
import warnings
import torchvision
from core.libs.GAGAvatar_track.GAGAvatar_track_main.engines.human_matting.stylematte import StyleMatte
...
class StyleMatteEngine(torch.nn.Module):
    ...
    def _init_models(self, ):
        ...
        _ckpt_path = os.path.join(_abs_script_path, '../../libs/GAGAvatar_track/GAGAvatar_track_main/assets/matting', 'stylematte_synth.pt')
