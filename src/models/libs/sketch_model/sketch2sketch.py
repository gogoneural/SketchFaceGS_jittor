...
if __name__ == '__main__':
    gpu_ids = ['0']
    Sketch2Tensor= networks_tensor.define_G(3, 3, 64, 'sketch2sketch', 
                                  4, 4, 1, 
                                  3, 'instance', gpu_ids)
    sketch_gen_checkpoint = '../code/face_getsketch_part/checkpoints/sketch2sketch_bg' +'/10_net_G.pth'
    Sketch2Tensor.load_state_dict(torch.load(sketch_gen_checkpoint))
    ...
    _, sketch = Sketch2Tensor(sketch_img)
    path = "./"
